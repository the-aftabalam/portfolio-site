...
export class ProjectsComponent implements OnInit {
  ...
  projects = [
    {
      title: 'Ahaar POS',
      description: 'Streamline your sales, order processing, and kitchen operations effortlessly with HB Aahar POS system. Integrated Swiggy and Zomato using Urban Piper platform, expanding project reach. Online Order Management.',
      image: 'assets/ahaar-pos.jpg',
    ...
    {
      title: 'HB Super App',
      description: 'HB Super App is a comprehensive business management solution developed by HostBooks Limited. Contributed to the development of a comprehensive business management solution, adding new APIs to enhance functionality.',
      image: 'assets/hb-super-app.jpg',
    ...
    },
    {
      ...
      image: 'assets/cricbuzz-clone.jpg',
    ...
    },
    {
      ...
      image: 'assets/nursery-plant-management.jpg',
